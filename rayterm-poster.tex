...
\vspace{1.5in}
\begin{center}
  \includegraphics[width=0.9\textwidth]{img/rayterm}
\end{center}
\vspace{-6in}
}{
%%%% Bottom space
...
RayTerm is a C++ path-tracing library that is performant, open-source, and programmable.
Its asthetic is both retro and futuristic: old pixilated graphics are combined with photorealistic lighting.
...
Ray-tracing is a computationally intensive process, however, and so lots of optimization and parrallelization is needed.
