...
\begin{minipage}[c][4in][b]{0.5\textwidth}
\begin{center}
{ \fontsize{16}{22} \selectfont CPU (\textasciitilde{}500 seconds, 6 objects) }
\includegraphics[width=0.9\textwidth]{img/hq-cpu}
\end{center}
\end{minipage}%
\begin{minipage}[c][4in][b]{0.5\textwidth}
\begin{center}
{ \fontsize{16}{22} \selectfont GPU (\textasciitilde{}20 seconds, 15k faces) }
